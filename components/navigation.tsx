    ...
    <nav className="fixed top-0 w-full z-40 bg-navy-dark/95 backdrop-blur border-b border-border">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <motion.div whileHover={{ scale: 1.05 }} className="flex items-center gap-3 cursor-pointer">
          <div className="w-12 h-12 rounded-full bg-gradient-wave p-0.5 flex items-center justify-center">
            <div className="w-full h-full rounded-full bg-navy-dark flex items-center justify-center">
              <span className="text-lg font-bold bg-gradient-wave bg-clip-text text-transparent">D</span>
            </div>
          </div>
